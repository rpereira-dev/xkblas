...
#define TASK_FLOPS FLOPS_ZTRSM(arg->side,arg->m,arg->n)
#define TASK_DATA  DATA_ZTRSM(arg->side,arg->m,arg->n)
...
#if 0//KAAPI_USE_OCR //WARNING: if force to not be OCR for this task then better perf
