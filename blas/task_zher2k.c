...
#define TASK_NAME zher2k
#define STRNAME  "zher2k"
#define NAME2(x,s) x##_##s
#define NAME(x) NAME2(x,zher2k)
#define PNAME(x) zher2k##_##x
#define NPARAM 3
...
#define TASK_FLOPS FLOPS_ZHER2K(arg->n,arg->k)
#define TASK_DATA  DATA_ZHER2K(arg->n,arg->k)
